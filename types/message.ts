export const MESSAGE_TYPES = {
  ...
  CHECK_CONNECTION_UI: 'CHECK_CONNECTION_UI',
  ...
  DISPLAY_VIDEOS_ON_SELECTED_PAGE: 'DISPLAY_VIDEOS_ON_SELECTED_PAGE',
  HIDDEN_UI: 'HIDDEN_UI',
  SAVE_TAB_INFO: 'SAVE_TAB_INFO',
  ENABLE_VIDEO_DETECTOR: 'ENABLE_VIDEO_DETECTOR',
  DISABLE_VIDEO_DETECTOR: 'DISABLE_VIDEO_DETECTOR',
  VIDEO_DETECTOR_STATUS: 'VIDEO_DETECTOR_STATUS',
};
